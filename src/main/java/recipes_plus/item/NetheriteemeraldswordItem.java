...
import recipes_plus.procedures.NetheriteemeraldswordeffectProcedure;
...
public class NetheriteemeraldswordItem extends SwordItem {
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		NetheriteemeraldswordeffectProcedure.execute(sourceentity);
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.recipes_plus.netheriteemeraldsword.description_0"));
	}
}
