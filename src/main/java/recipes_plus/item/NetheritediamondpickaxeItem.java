...
import recipes_plus.procedures.NetheritediamondpickaxeeffectProcedure;
...
public class NetheritediamondpickaxeItem extends PickaxeItem {
	...
	public boolean mineBlock(ItemStack itemstack, Level world, BlockState blockstate, BlockPos pos, LivingEntity entity) {
		...
		NetheritediamondpickaxeeffectProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ(), entity);
		return retval;
	}
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.recipes_plus.netheritediamondpickaxe.description_0"));
	}
}
